                    ...
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header">
                            <div class="logo-sm">
                                ...
                                <a class="logo-box" href="index.html"><span>Ikan Hoki</span></a>
                            </div>
                            ...
                            <form class="user">
                                <style>
                                    .form-container {
                                        display: flex;
                                        align-items: center;
                                        /* Menggunakan align-items: center; untuk menengahkan vertikal */
                                    }
                                    ...
                                    .image-preview {
                                        ...
                                        border-radius: 50%;
                                        margin-right: 10px;
                                        /* Memberi jarak antara pratinjau gambar dan unggah gambar */
                                    }
                                ...
                                <script>
                                    function previewImage(event) {
                                        ...
                                        imagePreview.style.backgroundImage = 'url(' + URL.createObjectURL(event.target
                                            .files[0]) + ')';
                                    }
                                </script>
                                <hr>
                                ...
                                <a href="index.html" class="btn btn-primary m-b-lg">
                                    Update Account
                                </a>
                            </form>
                        </div>
