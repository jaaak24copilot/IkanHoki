        ...
        <div class="page-content">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3 class="breadcrumb-header">Device Monitoring</h3>
                </div>
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                <div class="panel-body">
                                    <button type="button" class="btn btn-primary m-b-lg" data-toggle="modal"
                                        data-target="#myModal">Add New Device</button>
                                    <!-- Modal -->
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <select id="type-input" class="form-control" required>
                                                                <option value="">Select Type</option>
                                                                <option value="Small Aquarium">Small Aquarium</option>
                                                                <option value="Medium Aquarium">Medium Aquarium</option>
                                                                <option value="Big Aquarium">Big Aquarium</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" id="enddate-input"
                                                                class="form-control date-picker" placeholder="End Date"
                                                                required>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
